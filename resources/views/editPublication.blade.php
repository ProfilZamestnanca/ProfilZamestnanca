...
<div style="margin-left: auto" >
    <button type="button" class="btn reg-btn" data-toggle="modal" data-target="#editPublication{{$l.$i}}">Upraviť</button>
...
<div class="modal fade" id="editPublication{{$l.$i}}" tabindex="-1" role="dialog"
     aria-hidden="true">
    {!! Form::open(['action' => 'addController@storeEditPublication','method' => 'POST']) !!}
